          ...
          {item.card.info.imageId ? (
            <div className="w-3/12 h-40 p-4 relative ">
              ...
              <div className="absolute w-9/12 bottom-0 left-[100] transform -translate-x-1/2">
                <button className="rounded-xl p-2 bg-white font-bold w-9/12 text-green-800 shadow-lg  m-auto hover:bg-yellow-300">
                  ADD
                </button>
              </div>
            </div>
            ...
            <div className="bottom-0 my-2 transform -translate-x-10">
              <button className="rounded-xl py-2 px-8 bg-white font-bold w-12/12 text-green-800 shadow-lg  m-auto hover:bg-yellow-300">
                ADD
              </button>
            </div>
          )}
